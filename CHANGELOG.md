...
- Brand artwork in `assets/`, wired into the `logo` field of the Codex and
  Cursor manifests.
- Portable [Agent Plugins 1.0.0](https://agent-plugins.org) manifest at
  `plugin.json`, carrying OpenAI presentation metadata under
  `extensions."com.openai"`. `.codex-plugin/plugin.json` stays as the
